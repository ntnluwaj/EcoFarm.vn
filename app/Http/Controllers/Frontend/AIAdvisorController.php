...
Không được tự chế các liên kết khác.";
        ...
        if (empty($responseContent)) {
            if ($topic === 'Bệnh hại sầu riêng') {
                $responseContent = "Chào quý khách! Đối với bệnh nấm rỉ sắt hại sầu riêng mùa mưa dầm, quý khách cần chú ý cắt tỉa cành thông thoáng, dọn cỏ gốc để giảm ẩm độ. Về mặt thuốc BVTV, quý khách hãy phun ngay thuốc trừ nấm nội hấp cực mạnh **[Anvil 5SC Syngenta](/san-pham/thuoc-tru-benh-anvil-5sc-syngenta)** định kỳ 7-10 ngày/lần khi bệnh chớm xuất hiện để tiêu diệt mầm bệnh và phục hồi lá xanh.";
            } elseif ($topic === 'Kỹ thuật phân bón NPK') {
                $responseContent = "Chào quý khách! Việc bón thúc NPK giúp lúa đẻ nhánh tối đa và kích thích cây trồng phát triển rễ tốt. Khuyến nghị quý khách sử dụng **[Phân NPK Đầu Trâu 20-20-15](/san-pham/phan-bon-npk-dau-trau-20-20-15-cao-cap)** với hàm lượng dinh dưỡng cân đối Đa - Trung - Vi lượng, bón thúc gốc với liều lượng 150-250kg/ha.";
            } elseif ($topic === 'Đạm Ure Phú Mỹ') {
                $responseContent = "Chào quý khách! Phân đạm giúp lá xanh mướt và đẩy nhanh tốc độ đẻ nhánh của lúa. Quý khách nên bón phân đạm chất lượng cao là **[Phân bón Ure Phú Mỹ hạt trong](/san-pham/phan-bon-ure-phu-my-hat-trong)** cho lúa và rau màu với liều lượng bón lót hoặc bón thúc từ 100-150kg/ha.";
            } elseif ($topic === 'Phòng trừ sâu hại') {
                $responseContent = "Chào quý khách! Rầy nâu truyền bệnh lúa và sâu cuốn lá là dịch hại nghiêm trọng đầu vụ. Để bảo vệ cây lúa, quý khách hãy sử dụng thuốc trừ sâu phổ rộng cực mạnh **[Regent 800WG Bayer](/san-pham/thuoc-tru-sau-regent-800wg-bayer)** của Bayer. Hãy pha 1 gói 1.6g cho bình 16 - 25 Lít nước phun ướt đều tán lá.";
            } else {
                $responseContent = "Chào quý khách! Tôi là **EcoBot - Trợ lý ảo nông nghiệp AI** của EcoFarm.vn. Tôi có chuyên môn tư vấn cách bón phân NPK/Ure, trị bệnh rỉ sắt trên cây sầu riêng hoặc diệt sâu cuốn lá, rầy nâu hại lúa. Để xử lý hiệu quả nhất, quý khách có thể tham khảo các sản phẩm chính hãng của chúng tôi như **[Anvil 5SC Syngenta](/san-pham/thuoc-tru-benh-anvil-5sc-syngenta)** hoặc **[Regent 800WG Bayer](/san-pham/thuoc-tru-sau-regent-800wg-bayer)**.";
            }
        }
