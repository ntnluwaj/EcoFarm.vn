...
public function handle(Request $request, Closure $next): Response
{
    ...
    // Tiêu chí AC-05: Đang vào vùng quản trị nhưng không phải Admin, Nhân viên (staff) hoặc Kỹ sư (engineer) -> Đẩy ra trang chủ Frontend
    if (!in_array(Auth::user()->role, ['admin', 'staff', 'engineer']) && $request->is('admin*')) {
        return redirect('/');
    }
