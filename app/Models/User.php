...
class User extends Authenticatable implements FilamentUser, HasAvatar // 🌟 THỰC THI CHÍNH XÁC FILAMENTUSER VÀ HASAVATAR INTERFACES
{
    ...
    /**
     * Trả về URL ảnh đại diện cho Filament Admin Panel
     */
