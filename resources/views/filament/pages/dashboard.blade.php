    ...
    <div class="eco-academic-dashboard space-y-6">
        ...
        <div class="eco-banner-card flex flex-wrap items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-3">
                <a href="/admin/stock-report-page" class="px-4 py-2.5 rounded-xl bg-white text-emerald-900 hover:bg-emerald-50 font-extrabold text-xs shadow-md transition-all flex items-center gap-2">
