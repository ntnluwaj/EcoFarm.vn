...
<!-- 🌟 1. HERO HEADER BANNER (ELEGANT NATURE GRADIENT OVERLAY) -->
<div class="position-relative overflow-hidden text-white text-center py-5" style="background: linear-gradient(135deg, rgba(27, 94, 32, 0.92) 0%, rgba(46, 125, 50, 0.88) 100%), url('{{ asset('images/ecofarm_green_field.jpg') }}') no-repeat center center; background-size: cover; min-height: 260px; display: flex; align-items: center; justify-content: center;">
    <div class="container py-4 z-2 position-relative">
        <h1 class="display-4 fw-black mb-2 text-uppercase tracking-tight text-white" style="font-weight: 900; text-shadow: 0 3px 12px rgba(0,0,0,0.4);">Về Chúng Tôi</h1>
        ...
        <div class="d-inline-flex align-items-center gap-2 px-3.5 py-1.5 rounded-pill bg-white bg-opacity-20 text-white text-sm font-semibold backdrop-blur-sm border border-white border-opacity-25 shadow-sm">
...
<!-- 🌟 2. SECTION 1: INTERACTIVE STORY & STATS GRID (BALANCED 2-COLUMN LAYOUT - NO OVERLAPPING TEXT) -->
<div class="bg-white py-5 border-bottom">
    <div class="container py-4">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-1.5 rounded-pill bg-success-subtle text-success text-xs font-bold uppercase tracking-wider mb-3">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <div class="p-3.5 rounded-4 bg-light border border-slate-100 hover-lift transition-all">
                            <div class="display-6 fw-black text-success tracking-tight mb-1" style="font-weight: 900; font-size: 1.85rem;">10.000+</div>
                            <div class="text-muted text-xs font-bold uppercase">Nhà vườn tin dùng</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3.5 rounded-4 bg-light border border-slate-100 hover-lift transition-all">
                            <div class="display-6 fw-black text-success tracking-tight mb-1" style="font-weight: 900; font-size: 1.85rem;">94%</div>
                            <div class="text-muted text-xs font-bold uppercase">Tỷ lệ hài lòng</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3.5 rounded-4 bg-light border border-slate-100 hover-lift transition-all">
                            <div class="display-6 fw-black text-success tracking-tight mb-1" style="font-weight: 900; font-size: 1.85rem;">Top 100</div>
                            <div class="text-muted text-xs font-bold uppercase">Thương hiệu uy tín</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3.5 rounded-4 bg-light border border-slate-100 hover-lift transition-all">
                            <div class="display-6 fw-black text-success tracking-tight mb-1" style="font-weight: 900; font-size: 1.85rem;">15+</div>
            ...
            <div class="col-lg-6">
                ...
                <div class="position-relative mb-4">
                    <img src="{{ asset('images/ecofarm_engineer.jpg') }}" alt="Kỹ sư tư vấn nông nghiệp" class="img-fluid rounded-4 shadow-lg w-100 object-cover" style="height: 260px; border: 3px solid #ffffff;">
                    
                    <!-- Floating Green Badge Safely Positioned INSIDE Image (Bottom-Right) -->
                    <div class="position-absolute bottom-0 end-0 m-3 z-3">
                        <div class="p-3 rounded-4 text-white shadow-xl backdrop-blur-md" style="background: linear-gradient(135deg, rgba(27,94,32,0.95) 0%, rgba(46,125,50,0.95) 100%); border: 1.5px solid rgba(255,255,255,0.4); max-width: 200px;">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <img src="{{ asset('images/ecofarm_green_field.jpg') }}" alt="Cánh đồng Mekong" class="img-fluid rounded-4 shadow-sm w-100 object-cover" style="height: 120px;">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('images/ecofarm_warehouse.jpg') }}" alt="Kho vật tư" class="img-fluid rounded-4 shadow-sm w-100 object-cover" style="height: 120px;">
                    </div>
                </div>
                ...
                <div class="row g-2.5 pt-2">
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-2 p-2.5 rounded-3 bg-light border">
                            ...
                            <span class="fw-bold text-dark text-xs">Giá niêm yết trực tiếp nhà máy</span>
                        </div>
                    </div>
                </div>
...
<!-- 🌟 3. SECTION 2: FULL-WIDTH LUSH GREEN CALLOUT BANNER (ELEGANT FULL-WIDTH BANNER) -->
...
<!-- 🌟 4. SECTION 3: WHY CHOOSE ECOFARM / VALUE PROPOSITION (SLIM CLEAN CARDS) -->
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-5">
                <div class="position-relative">
                    <img src="{{ asset('images/ecofarm_warehouse.jpg') }}" alt="Kho vật tư EcoFarm" class="img-fluid rounded-4 shadow-xl w-100 object-cover" style="height: 380px;">
            ...
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <!-- Feature Box 1 -->
                    <div class="p-4 rounded-4 bg-white shadow-sm border border-slate-100 hover-lift transition-all d-flex align-items-start gap-3.5">
                        <div class="p-3 rounded-3 text-white shrink-0" style="background: linear-gradient(135deg, #1b5e20 0%, #2e7d32 100%); width: 52px; height: 52px; display: flex; align-items: center; justify-content: center; font-size: 22px; box-shadow: 0 8px 16px rgba(46, 125, 50, 0.25);">
                            <i class="fa-solid fa-sack-dollar"></i>
                        </div>
                        <div>
                            <h5 class="fw-extrabold text-dark mb-1" style="font-weight: 800; font-size: 1.05rem;">Giá Cả Cạnh Tranh & Ưu Đãi Đại Lý</h5>
                    ...
                    <div class="p-4 rounded-4 bg-white shadow-sm border border-slate-100 hover-lift transition-all d-flex align-items-start gap-3.5">
                        ...
                        <div>
                            <h5 class="fw-extrabold text-dark mb-1" style="font-weight: 800; font-size: 1.05rem;">Sản Phẩm Chính Hãng 100%</h5>
                            <p class="text-secondary small mb-0 leading-relaxed">
                    ...
                    <div class="p-4 rounded-4 bg-white shadow-sm border border-slate-100 hover-lift transition-all d-flex align-items-start gap-3.5">
                        ...
                        <div>
                            <h5 class="fw-extrabold text-dark mb-1" style="font-weight: 800; font-size: 1.05rem;">Đội Ngũ Kỹ Sư Nông Nghiệp Đồng Hành 24/7</h5>
                            <p class="text-secondary small mb-0 leading-relaxed">
