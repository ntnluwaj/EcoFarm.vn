...
@section('title', 'Tin Tức Nông Nghiệp & Thị Trường - EcoFarm')
...
<div class="container py-4" style="min-height: 80vh;">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb bg-white p-3 rounded-3 shadow-sm small mb-0">
            ...
            <li class="breadcrumb-item active text-muted" aria-current="page">Tin tức nông nghiệp</li>
        </ol>
    </nav>

    <!-- Header -->
    <div class="d-flex align-items-center mb-4">
        <div class="p-2 bg-success-subtle text-success rounded-3 me-3"><i class="fa-solid fa-newspaper fs-4"></i></div>
        <div>
                    ...
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white d-flex flex-column justify-content-between article-card transition-all">
                        ...
                        <div class="px-4 pb-4 bg-white">
                            <a href="{{ route('posts.show', $post->slug) }}" class="btn btn-outline-success btn-sm w-100 fw-bold rounded-3 py-2 text-xs">
                                Đọc bản tin nông nghiệp <i class="fa-solid fa-arrow-right ms-1"></i>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    @else
        ...
        <div class="card border-0 shadow-sm rounded-4 p-5 text-center bg-white">
            <div class="py-4 text-muted small">
                ...
                <h5 class="fw-bold text-dark mb-1">Tin tức nông nghiệp đang được biên soạn</h5>
                <p class="mb-0">Hệ thống đang cập nhật các tin tức thị trường và lịch mùa vụ mới. Vui lòng quay lại sau!</p>
            </div>
        </div>
    @endif
</div>
